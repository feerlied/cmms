...
/**
 * This class provides an empty implementation of {@see CMMSParserVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class CMMSParserBaseVisitor extends AbstractParseTreeVisitor implements CMMSParserVisitor
{
	/**
	 * {@inheritdoc}
	 *
